...
def fetchWeather():
  ...
  #echostrDict = {u'城市':city, u'温度':temperature, u'天气':condition, u'发布时间':curDate, u'实时温度':temp, u'风向':WD, u'pm25':pm25, u'农历':lunar}
  echostrDict = {'城市':city, '温度':temperature, '天气':condition, '发布时间':curDate, '实时温度':temp, '风向':WD, 'pm25':pm25, '农历':lunar}
  echostr = json.dumps(echostrDict, ensure_ascii=False)
  return echostr
